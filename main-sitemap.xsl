			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - ThinkerTation</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - ThinkerTation</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://stevesworkstation.github.io/thinkertation/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
